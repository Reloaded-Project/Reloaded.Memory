    ...
    where T : struct
{
    ...
    /// <param name="box">
    ///     The resulting <see cref="Box{T}" /> reference, if <paramref name="obj" /> was a boxed
    ///     <typeparamref name="T" /> value.
    /// </param>
    /// <returns>
    ///     <see langword="true" /> if a <see cref="Box{T}" /> instance was retrieved correctly, <see langword="false" />
    ///     otherwise.
    /// </returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    ...
    /// </summary>
    /// <exception cref="InvalidCastException">Can't cast the input object.</exception>
