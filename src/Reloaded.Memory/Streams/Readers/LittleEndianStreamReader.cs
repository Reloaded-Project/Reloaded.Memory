...
namespace Reloaded.Memory.Streams.Readers
{
    ...
    public partial class LittleEndianStreamReader : EndianStreamReader
    {
...
#endif
        T>(out T value, bool marshal) => Reader.Read(out value, marshal);
        ...
        public T Read<
            ...
            [DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicConstructors | DynamicallyAccessedMemberTypes.NonPublicConstructors)]
#endif
        T>(bool marshal) => Reader.Read<T>(marshal);
        ...
        public void Peek<
            ...
            [DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicConstructors | DynamicallyAccessedMemberTypes.NonPublicConstructors)]
#endif
        T>(out T value, bool marshal) => Reader.Peek(out value, marshal);
        ...
        public T Peek<
            ...
            [DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicConstructors | DynamicallyAccessedMemberTypes.NonPublicConstructors)]
#endif
        T>(bool marshal) => Reader.Peek<T>(marshal);
    }
}
