...
/// </summary>
[PublicAPI]
public unsafe struct LittleEndianWriter : IEndianWriter
{
    /// <summary>
    ...
    {
        LittleEndianHelper.Write((float*)Ptr, value);
        Ptr += sizeof(float);
    }
    ...
    {
        LittleEndianHelper.Write((double*)Ptr, value);
        Ptr += sizeof(double);
    }
    ...
    */
    ...
    /// <inheritdoc />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public void WriteAtOffset(ushort value, int offset) => LittleEndianHelper.Write((ushort*)(Ptr + offset), value);
    ...
    /// <inheritdoc />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public void WriteAtOffset(uint value, int offset) => LittleEndianHelper.Write((uint*)(Ptr + offset), value);
    ...
    /// <inheritdoc />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public void WriteAtOffset(float value, int offset) => LittleEndianHelper.Write((float*)(Ptr + offset), value);

    /// <inheritdoc />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public void WriteAtOffset(double value, int offset) => LittleEndianHelper.Write((double*)(Ptr + offset), value);
